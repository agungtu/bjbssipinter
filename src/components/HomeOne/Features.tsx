      ...
      <div id="pengguna" className="awsome-features pt-100 pb-70">
        <div className="container">
          <div
            ...
            data-aos-delay="100"
          >
            <h2 style={{ color: "#AF0321" }}>User</h2>
            <h3 style={{ color: "#AF0321" }}>Tersebar di seluruh wilayah Indonesia</h3>
          </div>
            ...
            {featuresData &&
              featuresData.map((value, i) => (
                <div className="col-md-6 col-lg-4"  key={i}>
                  <div
                    className="single-feature mb-30 rounded-4" style={{backgroundColor : "#AF0321"}}
                    data-aos="fade-in"
